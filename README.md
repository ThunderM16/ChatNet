...
This is the web client for ChatNet on Revolt, which is also available live at [app.revolt.chat Offical Revolt Client](https://app.revolt.chat) [app.chatnet.me Official ChatNet Client](https://app.chatnet.me).
